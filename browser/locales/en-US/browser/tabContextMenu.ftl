...
## Container switching — close all tabs of the current container and reopen
## the current page in a different container.

tab-context-switch-container =
    .label = Switch Container…
    .accesskey = h
# Variables:
#   $count (Number) - number of tabs that will be closed
#   $from (String) - name of the current container
#   $to (String) - name of the target container
tab-context-switch-container-confirm-title = Switch Container
tab-context-switch-container-confirm-msg =
    Close all { $count } tab(s) in { $from } and reopen this page in { $to }?
tab-context-switch-container-confirm-button = Switch
tab-context-switch-container-cancel-button = Cancel
move-to-start =
    .label = Move to Start
    .accesskey = S
move-to-end =
