...
const toolsNameMap = {
  ...
  viewContainersSidebar: "containers",
...
var SidebarController = {
  ...
  generateSidebarsMap() {
    this._sidebars = new Map([
      ...
      [
        "viewContainersSidebar",
        this.makeSidebar({
          name: "containers",
          elementId: "sidebar-switcher-containers",
          url: "chrome://browser/content/sidebar/sidebar-containers.html",
          menuId: "menu_containersSidebar",
          keyId: "viewContainersSidebarKb",
          menuL10nId: "menu-view-containers",
          revampL10nId: "sidebar-menu-containers-label",
          iconUrl: "chrome://browser/skin/icons/fingerprint.svg",
        }),
      ],
    ]);
