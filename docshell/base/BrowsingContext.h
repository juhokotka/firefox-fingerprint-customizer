...
class BrowsingContext : public nsILoadContext, public nsWrapperCache {
 ...
 public:
  ...
  void GetCustomOscpu(nsAString& aOscpu) {
    aOscpu = Top()->GetOscpuOverride();
  }
